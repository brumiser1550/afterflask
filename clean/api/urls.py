...
urlpatterns = [
    ...
    url(r'^feedback/(?P<pk>[0-9]+)/$', views.FeedbackDetail.as_view(), name='feedback_detail'),
    ...
    url(r'^technicians/(?P<pk>[0-9]+)/$', views.TechnicianDetail.as_view(), name='technician_detail'),
]
